...
import (
	...
	"github.com/rosmo/docker-credential-gcr/v2/mock/mock_cmd"
	"github.com/rosmo/docker-credential-gcr/v2/mock/mock_config" // mocks must be generated before test execution
	"github.com/rosmo/docker-credential-gcr/v2/mock/mock_store"

	"github.com/rosmo/docker-credential-gcr/v2/config"
	"github.com/rosmo/docker-credential-gcr/v2/store"
	"github.com/rosmo/docker-credential-gcr/v2/util/cmd"
